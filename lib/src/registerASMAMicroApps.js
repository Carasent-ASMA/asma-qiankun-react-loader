...
import { __MICROAPP_REGISTRY } from './registry/microapp-registry';
let asmaRegistrableApps;
...
export async function setAsmaRegistrableAppsNew(reg_app_names, env = 'cloud', devtools = false) {
 ...
 * @param devtools bool
 */
async function setAsmaRegistrableApps(registrable_apps, devtools) {
    if (!registrable_apps) {
...
//# sourceMappingURL=registerASMAMicroApps.js.map